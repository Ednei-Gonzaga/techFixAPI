...
public class UserController {
    ...
    public ResponseEntity teste(@RequestBody @Valid RequestResetPasswordUser requestResetPasswordUser, @AuthenticationPrincipal User user) {

       userService.updatePassword(requestResetPasswordUser, user);

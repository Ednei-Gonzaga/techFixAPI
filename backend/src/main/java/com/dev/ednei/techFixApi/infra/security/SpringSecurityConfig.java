    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v2/service-requests").hasAnyRole("MANAGER", "ATTENDANT")
                        .requestMatchers(HttpMethod.GET, "/api/v2/service-requests").hasAnyRole("MANAGER", "ATTENDANT")
                        .requestMatchers(HttpMethod.GET, "/api/v2/service-requests/*").hasAnyRole("MANAGER", "TECHNICAL", "ATTENDANT")
                        .requestMatchers(HttpMethod.PUT, "/api/v2/service-requests/*").hasAnyRole("MANAGER", "ATTENDANT")
                        .requestMatchers(HttpMethod.GET, "/api/v2/service-orders", "/api/v2/service-orders/*").hasAnyRole("MANAGER", "TECHNICAL", "ATTENDANT")
                        .requestMatchers(HttpMethod.PUT, "/api/v2/service-orders/*").hasAnyRole("MANAGER", "TECHNICAL", "ATTENDANT")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/v2/users/*").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.POST, "/api/v2/parts").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/v2/parts", "/api/v2/parts/*").hasAnyRole("MANAGER", "TECHNICAL", "ATTENDANT")
                        .requestMatchers(HttpMethod.PUT, "/api/v2/parts/*").hasRole("MANAGER")
                        ...
                        .requestMatchers("/api/v2/dashboard/metrics", "/api/v2/real-time-alerts", "/api/v2/whatsapp/**", "/api/v2/service-order/*/history/updates", "/api/v2/service-order/*/payment/history").hasRole("MANAGER")
